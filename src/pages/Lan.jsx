...
const Lan = () => {
  return (
    <div className="h-auto lg:auto w-[100vw] bg-[#2257bf] text-white">
      ...
      <h1 className="font-bold text-[30px] lg:text-[35px] py-[10%] lg:py-[5%]">Network Design & Implementation</h1>
    ...
    <div className="w-[100%] lg:w-[50%] lg:pl-[5%] pt-[9%] lg:pt-[0px] pb-[10%] lg:pb-0 flex text-center justify-center place-items-center">
      <img src={network_photo} alt="network photo" height={450} width={500} className="object-contain rounded-[200px]"/>
    </div>
    </div>
    </div>
