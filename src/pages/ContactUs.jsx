    ...
    <div className="h-auto w-[100vw]  text-[15px]">
      <div className="bg-[url(assets/about_oreegi.jpg)] flex flex-col">
        <div className="place-self-center w-[80vw] bg-[#10295B] opacity-70 h-auto mt-[10vh] mb-[13vh] py-[3vh] rounded-[50px]">
          <h1 className="text-center font-bold text-[28px] opacity-100">Get in Touch</h1>
      ...
      <div className="h-auto lg:h-[80vh] w-[100vw] bg-[#F8F8FF] flex flex-col lg:flex-row justify-center gap-[8vw] pb-[10vh]">
        ...
        <div
          className={`h-auto w-[90vw] lg:w-[30vw] ml-[5vw] bg-white border-[2px] flex flex-col py-[10vh] px-[5vw] justify-center place-content-center text-center mt-[10vh] lg:mt-[-10vh] rounded-[15px] box-shadow2 shadow-lg`}
        >
          <form
