...
const Partners = () => {
  return (
    <div className="h-auto lg:h-[30vh] w-[100vw] flex flex-row content-center justify-normal">
      ...
      <div className="hidden lg:flex h-[100%] w-[50%] content-center justify-center place-items-center text-center text-[13px] pl-[5%] pr-[15%] py-[5%] bg-[#F8F8FF] text-black border-dashed border-black shadow-md">
        <p>
