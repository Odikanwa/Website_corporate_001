    ...
    <div className="h-[100vh] w-[100vw] ">
      ...
      >
        ...
        <div className='flex flex-col justify-center content-center w-[40vw] px-5 py-5 rounded-lg text-white'>
          <h1 className="font-poppins font-bold text-[white] lg:text-[40px] sm:text-[35px] xs:text-[30px] text-[40px] lg:leading-[40px] text-left mt-2 animate-slideRight-animation delay-500 contrast-100">
