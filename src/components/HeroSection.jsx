...
const HeroSection = () => {
  return (
    <div className="h-[100vh] w-[100vw] ">
      ...
      <div
        className={`w-[100vw] h-auto m-0 absolute top-[30%] lg:top-[33%] left-[2%] text-center max-w-full lg:max-w-7xl flex flex-col justify-center items-center z-10`}
      >
        {/* <div className='bg-[rgba(17,14,51,0.5)] w-[40vw] px-5 py-5 rounded-lg text-white'> */}
        <div className="flex flex-col justify-center content-center w-[80vw] lg:w-[100%] px-5 py-5 rounded-lg text-white">
