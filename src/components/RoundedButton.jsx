...
const RoundedButton = ({children, value}) => {
  return (
    <div className='bg-white text-[#000] text-md font-bold w-[37vw] md:w-[150px] p-[10px] text-center justify-center rounded-[100px] mt-11 cursor-pointer border-white border-[2px] hover:bg-[#0ef] hover:shadow-[#0ef] shadow-lg drop-shadow-lg'>
        {children}
    </div>
  )
}
