const Services = () => {
  return (
    <div className="h-auto lg:h-auto w-[100vw] flex flex-row content-center justify-normal border-t-[3px]">
      ...
      <div className="flex flex-col h-[100%] w-[100%] content-center justify-center place-items-center text-center text-[13px]  px-[10%] py-[5%] lg:py-[3%] bg-[#F8F8FF] text-black border-dashed">
        <h1 className="font-bold text-[16px] py-[5px] text-black]">
          Our Solutions
        </h1>
