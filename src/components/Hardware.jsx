const Hardware = () => {
  return (
    <div className="h-[100vh] w-[100vw]  bg-[#F8F8FF] text-black px-[10vw] py-[10vh] border-t-[3px] z-100">
      <h1 className="font-bold text-[20px] lg:text-[30px] pb-[3%]">Hardware <span className="text-[#14adb8]">Market</span>place<span className="text-[#14adb8]">.</span></h1>
