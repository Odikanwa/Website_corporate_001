const Hardware = () => {
  return (
    <div className="h-[100vh] w-[100vw]  bg-[#F8F8FF] text-black px-[10vw] py-[10vh]">
      ...
      <div className="bg-[url(assets/hardware.png)] h-[90%] w-[100%] relative object-contain rounded-3xl">
        {/* <div className="absolute bottom-0 px-4 py-3 bg-[rgba(20,52,114,0.8)] w-full"> */}
