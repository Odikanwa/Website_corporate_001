...
const Hardware = () => {
  return (
    <div className="h-[100vh] w-[100vw]  bg-[#F8F8FF] text-black px-[10vw] py-[10vh]">
        ...
        <div
        className={`m-0 w-[100%] h-[90%] mt-[-38%] inset-0  text-center max-w-7xl flex items-start z-10`}
      >

        <div className='bg-[rgba(17,14,51,0.8)] h-[100%]  w-[100%] px-5 py-5 text-white rounded-[50px]'>
