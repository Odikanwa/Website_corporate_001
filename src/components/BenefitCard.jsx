  ...
  return (
    ...
    <div className="h-auto w-[100%] flex flex-col lg:flex-row flex-wrap gap-[5vh] lg:gap-[2vw] py-[10vh] mr-[5vw] place-self-center justify-center place-items-center items-center">
        {benefits_aboutus.map((benefit) => (
            <div key={benefit.id} className="w-[80vw] lg:w-[30vw] flex flex-row text-left px-[4vw] lg:px-[2vw] py-[6vh] gap-3 bg-white border-[1px] justify-center place-content-center drop-shadow-lg shadow-md rounded-[20px]">
